...
//------++++++------++++++------++++++------++++++------++++++------++++++------
GammaEfficienciesMaterials *GammaEfficienciesMaterials::GammaEfficienciesmaterials = 0;
GammaEfficienciesMaterials::GammaEfficienciesMaterials()
{
  if(GammaEfficienciesmaterials){
    G4cerr<<"GammaEfficienciesMaterials is a singleton:: an instance already exists!"<<G4endl;
    //    delete GammaEfficienciesmaterials;
    exit(1);
  }  
  CreateMaterials();
//  CreateOpticalSurfaces();
  ...
  GammaEfficienciesmaterials = this;
}
...
{
  return GammaEfficienciesmaterials;
}

//------++++++------++++++------++++++------++++++------++++++------++++++------
//				   GetMaterialByName()
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4Material *GammaEfficienciesMaterials::GetMaterialByName(G4String mat_name)
{
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4VisAttributes *GammaEfficienciesMaterials::GetVisAttributesByName(G4String mat_name)
{
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
// G4MaterialPropertiesTable *GammaEfficienciesMaterials::GetPropertiesTableByName(G4String mat_name)
// {
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4OpticalSurface *GammaEfficienciesMaterials::GetOpticalSurfaceByName(G4String optical_name)
{
...
void GammaEfficienciesMaterials::CreateMaterials()
{
  //
  //	Isotopes
  ...
  G4Isotope * La139 = new G4Isotope("La139",57,139,139.*g/mole);
  G4Isotope * La138 = new G4Isotope("La138",57,138,138.*g/mole);
  ...
  G4Element * natBr = new G4Element("Natural bromine","natBr",2);
  natBr->AddIsotope( Br79, 51.*perCent );
  natBr->AddIsotope( Br81, 49.*perCent );

  G4Element * natLa = new G4Element("Natural Lanthanum","natLa",2);
  natLa->AddIsotope( La138, 0.089*perCent );
  natLa->AddIsotope( La139, 99.911*perCent );
...
//  materials ["liquidXe"] = liquidXe;
  ...
  lanthanumBromide = new G4Material("LaBr3", 5.08 * g/cm3, 2, kStateSolid,
                                     295.*kelvin, 1.*bar);
  lanthanumBromide->AddElement( natLa, 1 );
  lanthanumBromide->AddElement( natBr, 3 );

  mat_ = GetMaterialByName("LaBr3");
  if (mat_) delete mat_;
  materials["lanthanumBromide"] = lanthanumBromide;
...
//					CreateOpticalSurfaces()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void GammaEfficienciesMaterials::CreateOpticalSurfaces()
{
...
//					CreateVisualAttributes()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void GammaEfficienciesMaterials::CreateVisualAttributes()
{
