...
//				XeNeu_TOFDetector
//------++++++------++++++------++++++------++++++------++++++------++++++------
XeNeu_TOFDetector::XeNeu_TOFDetector(int det_num)
{
  ...
  double full_assembly_half_length = 4.5 * 2.54 * cm; 
   ...
   G4Tubs * TOFDetectorVolume_box = new G4Tubs("detector", 
                                             0.*cm, 
                                             detector_radius + 1.5*mm, 
                                             full_assembly_half_length + 3.*mm,
                                             0.*deg,360.*deg);
  lsDetectorVolume_log = new G4LogicalVolume( TOFDetectorVolume_box, BACCmaterials->Vacuum(), "lsDetectorVolume");
  ...
  G4Tubs * detector_shell_tubs = new G4Tubs("detector_shell_tubs",
                                             ...
                                             0.*deg,360.*deg);
  G4Tubs * detector_shell_cutout_tubs = new G4Tubs("tof_detector_shell_cutout_tubs",
                                             0.,
  ...
  char shellname[100];
  sprintf(shellname,"tof_detector_shell_%d",det_num);
  ...
  char toftargetname[100];
  sprintf(toftargetname,"tof_target_%d",det_num);
  ...
  G4Tubs * lead_sheath_round = new G4Tubs("lead_sheath_round",
                                 detector_radius,
                                 detector_radius + 1.5*mm,
                                 detector_half_length,
                                 0.*deg,360.*deg);
  G4LogicalVolume * lead_sheath_log = new G4LogicalVolume( lead_sheath_round, BACCmaterials->Lead(), "lead_sheath_log");
  ...
  BaccDetectorComponent * lead_face = new BaccDetectorComponent(0,
                                            G4ThreeVector(0.,0.,-full_assembly_half_length-1.5*mm),
                                            lead_face_log,
                                            lead_face_name,
                                            lsDetectorVolume_log,
                                            0,0,true);
...
//				~XeNeu_TOFDetector
//------++++++------++++++------++++++------++++++------++++++------++++++------
XeNeu_TOFDetector::~XeNeu_TOFDetector(){}
