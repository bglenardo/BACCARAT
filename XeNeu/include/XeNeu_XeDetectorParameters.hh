...
namespace XeNeuDetectorParameters{
  ...
  extern double outerCanInnerRadius;
  extern double outerCanOuterRadius;
  extern double outerCanHalfHeight;

  // Inner Steel Can
  //double innerCanInnerRadius = (2.0 - 1./16.) * 2.54 * cm;
  //double innerCanOuterRadius = 2.0 * 2.54 * cm;
  //double innerCanHalfHeight = 7. * 2.54 * cm;
  extern double innerCanInnerRadius;
  extern double innerCanOuterRadius;
  extern double innerCanHalfHeight;
  ...
  extern double teflonBlockOuterRadius;
  extern double teflonBlockInnerRadius;
  extern double teflonBlockHalfHeight;
  ...
  extern double weirCutoutAngle;
  extern double weirInnerRadius;
  extern double weirOuterRadius;
  extern double weirHalfHeight;
  extern double weirPocketOuterRadius;
  extern double weirPocketInnerRadius;
  extern double weirPocketCutoutAngle;
  ...
  extern double fieldRingInnerRadius;
  extern double fieldRingOuterRadius;
  extern double fieldRingHalfHeight;
  extern double fieldGridHalfHeight;

  // Bottom PMT
  //double bottomPMTHalfHeight = 2.2 * 2.54 * cm;
  //double bottomPMTRadius = 2.244/2. * 2.54 * cm;
  extern double bottomPMTHalfHeight;
  extern double bottomPMTRadius;


  // LS detector
  //double LSdetectorRadius = 2. * 2.54 * cm;
  //double LSdetectorHalfHeight = 2. * 2.54 * cm;
  extern double LSdetectorRadius;
  extern double LSdetectorHalfHeight;
