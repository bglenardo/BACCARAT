////////////////////////////////////////////////////////////////////////////////
/*   BaccGeneratorLZbkgGammas.cc
*
* This is the code file for the LZ bkg gamma generator
*
********************************************************************************
* Change log
...
//
/*
This generator shoots gammas from the LXe TPC in the LZDetector geometry.
The starting positions of the gammas are biased according to an input temperature 
map of single scatter sites in z, r^2 space.  The starting positions are distributed 
symmetrically in azimuthal angle.

The reason for creating this generator is to understand the fate of bkg gammas in the 
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
BaccGeneratorLZbkgGammas::BaccGeneratorLZbkgGammas()
{
   name = "LZbkgGammas";
   ...
   LoadWeights("generator/src/LZbkgGammas_all_new.dat"); //everything, new
   //LoadWeights("generator/src/LZbkgGammas_pmt_new.dat"); //PMT only, new
   //LoadWeights("generator/src/LZbkgGammas_ptfe_new.dat"); //PTFE only, new
   //LoadWeights("generator/src/LZbkgGammas_cryo_new.dat"); //Cryo only, new
   
   //Which energy distribution to use?
   //Only one of these should be uncommented at a time
   //LoadGammaEnergies("generator/src/LZbkgGammaEnergies_all_new.dat");
...
//               GenerateEvent()
//------++++++------++++++------++++++------++++++------++++++------++++++------
//void BaccGeneratorLZbkgGammas::GenerateEvent( G4GeneralParticleSource *particleGun,
//      G4Event *event )
//------++++++------++++++------++++++------++++++------++++++------++++++------
//                    GenerateEventList()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void BaccGeneratorLZbkgGammas::GenerateEventList( G4ThreeVector position,
...
//------++++++------++++++------++++++------++++++------++++++------++++++------
void BaccGeneratorLZbkgGammas::GenerateFromEventList( G4GeneralParticleSource
       *particleGun, G4Event *event, decayNode *firstNode  )
{
     ...
     G4double singleGammaEnergy = GetGammaEnergy();
     particleGun->GetCurrentSource()->GetEneDist()->SetMonoEnergy(singleGammaEnergy*MeV );
...
//               GetGammaEnergy()
//------++++++------++++++------++++++------++++++------++++++------++++++------
G4double BaccGeneratorLZbkgGammas::GetGammaEnergy()
{
/*
   ...
   G4double energy = gammaEnergy[indexLo] +
         split*(gammaEnergy[indexHi] - gammaEnergy[indexLo]);
*/   
   
   
   //get gamma energy by the same method as position
   ...
   while( rando >= 0. ){
      ...
      if ( rando < energyWeights[energybin] ){
         ...
         energy = gammaEnergies[energybin];
...
//               GetZPostion()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void BaccGeneratorLZbkgGammas::SetPosition()
{
...
//               LoadWeights()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void BaccGeneratorLZbkgGammas::LoadWeights(G4String fileName) {
  std::ifstream file;
  file.open(fileName);
  if (!file.is_open()) {
...
//               LoadGammaEnergies()
//------++++++------++++++------++++++------++++++------++++++------++++++------
void BaccGeneratorLZbkgGammas::LoadGammaEnergies(G4String fileName) {
  std::ifstream file;
  file.open(fileName);
  if (!file.is_open()) {
    G4cout<<G4endl<<G4endl<<G4endl;
