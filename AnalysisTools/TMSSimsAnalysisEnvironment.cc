...
#include "TMSSimsAnalysisEnvironment.hh"
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
TMSSimsAnalysisEnvironment::TMSSimsAnalysisEnvironment() {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
bool TMSSimsAnalysisEnvironment::IsDataLoaded() {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::PrintOutEnergyDepInfo(int event_num) {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::PrimaryNeutronScatteringVolumes() {
...
//  num_events = 100;
  ...
  for(int e=0; e < num_events; e++) {
     if( e % 1000000 == 0 ) cout << "Processing event " << e << " of " << num_events << endl;
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::DirectionOfPrimariesForScatteringEvents() {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
bool TMSSimsAnalysisEnvironment::IsSingleScatter() {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::LoadInputRootFile( string fname ) {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::PrintTree() {
  cout << "eventsTree pointer: " << eventsTree << endl;
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::PrintCurrentEvtDetails() {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::FindVolumeID( string vname ) {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::LoadInputChain( string dir ) {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
double TMSSimsAnalysisEnvironment::ComputeDistance( double x1[3], double x2[3] ) {
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::ReduceSimulatedData(string outfilePrefix = "TMSReducedData") {
...
//   }
  ...
  double dTotEDepActive_keV,
         ...
         dTotEDepChan1_keV,
         dTotEDepChan2_keV,
         dTimeFirstHitActive_ns,
         dEventSizeInActive_mm,
         dTimeFirstHitPSD1_ns,
         dTimeFirstHitPSD2_ns,
         dTotEDepPSD1_keV,
         dTotEDepPSD2_keV,
         dTotEDepInactive_keV,
         dActiveRecoilCosTheta,
         dEscapeTime_ns,
         dPosX, dPosY, dPosZ;
  ...
  int nNuclearRecoilsAbove100keVActive;
  int nProtonRecoilsActive;
  int nCarbonRecoilsActive;
  int nSiliconRecoilsActive;
  int nNuclearRecoilsInactiveTMS;
  int nProtonRecoilsInactiveTMS;
  int nCarbonRecoilsInactiveTMS;
  int nSiliconRecoilsInactiveTMS;
  ...
  data->Branch("dTotEDepChan0_keV",&dTotEDepChan0_keV,"dTotEDepChan0_keV/D");
  data->Branch("dTotEDepChan1_keV",&dTotEDepChan1_keV,"dTotEDepChan1_keV/D");
  data->Branch("dTotEDepChan2_keV",&dTotEDepChan2_keV,"dTotEDepChan2_keV/D");
  data->Branch("dTimeFirstHitActive_ns",&dTimeFirstHitActive_ns,"dTimeFirstHitActive_ns/D");
  data->Branch("dEventSizeInActive_mm",&dEventSizeInActive_mm,"dEventSizeInActive_mm/D");
  data->Branch("dTimeFirstHitPSD1_ns",&dTimeFirstHitPSD1_ns,"dTimeFirstHitPSD1_ns/D");
  data->Branch("dTimeFirstHitPSD2_ns",&dTimeFirstHitPSD2_ns,"dTimeFirstHitPSD2_ns/D");
  data->Branch("dTotEDepPSD1_keV",&dTotEDepPSD1_keV,"dTotEDepPSD1_keV/D");
  data->Branch("dTotEDepPSD2_keV",&dTotEDepPSD2_keV,"dTotEDepPSD2_keV/D");
  data->Branch("dTotEDepInactive_keV",&dTotEDepInactive_keV,"dTotEDepInactive_keV/D");
  data->Branch("sActiveProcessNames",&sActiveProcessNames);
  data->Branch("sOtherMaterials",&sOtherMaterials);
  data->Branch("bSSInActive",&bSSInActive,"bSSInActive/O");
  data->Branch("bUnresolvedMSInActive",&bUnresolvedMSInActive,"bUnresolvedMSInActive/O");
  data->Branch("bMSOtherMat",&bMSOtherMat,"bMSOtherMat/O");
  data->Branch("nEnergyDepositsActive",&nEnergyDepositsActive,"nEnergyDepositsActive/I");
  data->Branch("nEnergyDepositsTotal",&nEnergyDepositsTotal,"nEnergyDepositsTotal/I");
  data->Branch("nNuclearRecoilsActive",&nNuclearRecoilsActive,"nNuclearRecoilsActive/I");
  data->Branch("nNuclearRecoilsAbove100keVActive",&nNuclearRecoilsAbove100keVActive,"nNuclearRecoilsAbove100keVActive/I");
  data->Branch("nProtonRecoilsActive",&nProtonRecoilsActive,"nProtonRecoilsActive/I");
  data->Branch("nCarbonRecoilsActive",&nCarbonRecoilsActive,"nCarbonRecoilsActive/I");
  data->Branch("nSiliconRecoilsActive",&nSiliconRecoilsActive,"nSiliconRecoilsActive/I");
  data->Branch("nNuclearRecoilsInactiveTMS",&nNuclearRecoilsInactiveTMS,"nNuclearRecoilsInactiveTMS");
  data->Branch("nProtonRecoilsInactiveTMS",&nProtonRecoilsInactiveTMS,"nProtonRecoilsInactiveTMS");
  data->Branch("nCarbonRecoilsInactiveTMS",&nCarbonRecoilsInactiveTMS,"nCarbonRecoilsInactiveTMS");
  data->Branch("nSiliconRecoilsInactiveTMS",&nSiliconRecoilsInactiveTMS,"nSiliconRecoilsInactiveTMS");
  data->Branch("bEMEnergyDepActive",&bEMEnergyDepActive,"bEMEnergyDepActive/O");
  data->Branch("bEMEnergyDepPSD1",&bEMEnergyDepPSD1,"bEMEnergyDepPSD1/O");
  data->Branch("bEMEnergyDepPSD2",&bEMEnergyDepPSD2,"bEMEnergyDepPSD2/O");
  ...
  data->Branch("dActiveRecoilCosTheta",&dActiveRecoilCosTheta,"dActiveRecoilCosTheta/D");
  data->Branch("bNeutronHitPSD1",&bNeutronHitPSD1,"bNeutronHitPSD1/O");
  data->Branch("bNeutronHitPSD2",&bNeutronHitPSD2,"bNeutronHitPSD2/O");
  data->Branch("bHitPMTAssembly",&bHitPMTAssembly,"bHitPMTAssembly/O");
  data->Branch("bNeutronEscape",&bNeutronEscape,"bNeutronEscape/O");
  data->Branch("bGammaEscape",&bGammaEscape,"bGammaEscape/O");
  data->Branch("dEscapeTime_ns",&dEscapeTime_ns,"dEscapeTime_ns/D");
  ...
  printf("Just before entries loop.\n");
  for(int i=0; i<nentries; i++){
  //for(int i=1110; i<1111; i++){
      //printf("Entries loop: %d\n",i);
      ...
      dTotEDepChan1_keV = 0.;
      dTotEDepChan2_keV = 0.;
      dEventSizeInActive_mm = 0.;
      dTimeFirstHitActive_ns = -1000.;
      dTimeFirstHitPSD1_ns = -1000.;
      dTimeFirstHitPSD2_ns = -1000.;
      dEscapeTime_ns = -1000.;
      dTotEDepPSD1_keV = 0.;
      dTotEDepPSD2_keV = 0.;
      ...
      nNuclearRecoilsAbove100keVActive = 0;
      nProtonRecoilsActive = 0;
      nCarbonRecoilsActive = 0;
      nSiliconRecoilsActive = 0;
      nNuclearRecoilsInactiveTMS = 0;     
      nProtonRecoilsInactiveTMS = 0;     
      nCarbonRecoilsInactiveTMS = 0;     
      nSiliconRecoilsInactiveTMS = 0;     
      iActiveRecoilNucleus = -1;
      dActiveRecoilCosTheta = -2.; 
      bNeutronEscape = false;
      bGammaEscape = false;
      sCreatorProcess.clear();
      //printf("Finished setting all reduced variables.\n");

      if( current_evt->primaryParticles.size() == 0 ) continue;
      //printf("Checked if there are no primary particles in current_evt.\n");

      vector<stepInfo> steps;
      vector<trackInfo> tracks = current_evt->tracks;
      vector<vector<double>> positionsInActiveVolume;
      bool hitPSDAlready = false;
      bool hitActiveAlready = false;
      if( i == 86996 )
        printf("dActiveRecoilCosTheta_before = %f\n",dActiveRecoilCosTheta);
      bool is_recoiling_nucleus = false;

      for(size_t tr=0; tr<tracks.size(); tr++) {
          is_recoiling_nucleus = false;
          steps = tracks[tr].steps;
          ...
          if( (tracks[tr].iParticleID > 1000000000 || tracks[tr].iParticleID == 2212) && 
              ( tracks[tr].steps[0].sVolumeName == "active_tms_volume" || 
                tracks[tr].steps[0].sVolumeName == "tms_channel_0" ||
                tracks[tr].steps[0].sVolumeName == "tms_channel_1" ||
                tracks[tr].steps[0].sVolumeName == "tms_channel_2") ){
              is_recoiling_nucleus = true;
              //printf("Particle ID: %ld, num_steps = %d\n",tracks[tr].iParticleID,(int)steps.size());
        
              iActiveRecoilNucleus = tracks[tr].iParticleID; 
              dActiveRecoilCosTheta = tracks[tr].steps[0].dDirection[2] / 
                                       sqrt( pow( tracks[tr].steps[0].dDirection[0], 2. ) +
                                             pow( tracks[tr].steps[0].dDirection[1], 2. ) + 
                                             pow( tracks[tr].steps[0].dDirection[2], 2. ) );
              if( dActiveRecoilCosTheta < -10. ){
                  printf("Direction: (%f, %f, %f)\n",tracks[tr].steps[0].dDirection[0],
                                                     tracks[tr].steps[0].dDirection[1],
                                                     tracks[tr].steps[0].dDirection[2]);
              }
          }
          ...
          for(size_t st=0; st<steps.size(); st++) {
              if( steps[st].sVolumeName == "active_tms_volume" ||
                  steps[st].sVolumeName == "tms_channel_0" ||
                  steps[st].sVolumeName == "tms_channel_1" ||
                  steps[st].sVolumeName == "tms_channel_2" ) {
                  ...
                  track_energy += steps[st].dEnergyDep_keV;
                  if( steps[st].sVolumeName == "tms_channel_0" ) dTotEDepChan0_keV += steps[st].dEnergyDep_keV;
                  else if( steps[st].sVolumeName == "tms_channel_1" ) dTotEDepChan1_keV += steps[st].dEnergyDep_keV;
                  else if( steps[st].sVolumeName == "tms_channel_2" ) dTotEDepChan2_keV += steps[st].dEnergyDep_keV;
                  //if( true ) printf("\tPID: %ld Step %d: %4.4f keV in %s (chan0: %4.4f keV, tot: %4.4f keV)\n",
                  //                                  tracks[tr].iParticleID,st,steps[st].dEnergyDep_keV,steps[st].sVolumeName.c_str(),
                  //                                  dTotEDepChan0_keV,dTotEDepActive_keV);
                  ...
                  if( !hitActiveAlready ) {
                    ...
                    dPosX = steps[st].dPosition_mm[0];
                    dPosY = steps[st].dPosition_mm[1];
                    dPosZ = steps[st].dPosition_mm[2];
                    dTimeFirstHitActive_ns = steps[st].dTime_ns;
                    bSSInActive = true;
                  } else {
                  ...
                  position.push_back(steps[st].dPosition_mm[0]);
                  position.push_back(steps[st].dPosition_mm[1]);
                  position.push_back(steps[st].dPosition_mm[2]);
                  positionsInActiveVolume.push_back(position);
                  hitActiveAlready = true;
              } else // end if( volume == active_tms_volume )
              if( steps[st].sVolumeName == "psd_target_1" ) {
                  dTotEDepPSD1_keV += steps[st].dEnergyDep_keV;
                  if( !hitPSDAlready ) {
                      dTimeFirstHitPSD1_ns = steps[st].dTime_ns;
                      hitPSDAlready = true;
                  }
                  if( tracks[tr].iParticleID == 11 ||
                      tracks[tr].iParticleID == -11 ||
                      tracks[tr].iParticleID == 22 )
                      bEMEnergyDepPSD1 = true;
                  if( tracks[tr].iParticleID == 2212 ) 
                      bNeutronHitPSD1 = true;
              } else if( steps[st].sVolumeName == "psd_target_2" ){
                  dTotEDepPSD2_keV += steps[st].dEnergyDep_keV;
                  if( !hitPSDAlready ) {
                      dTimeFirstHitPSD2_ns = steps[st].dTime_ns;
                      hitPSDAlready = true;
                  }
                  if( tracks[tr].iParticleID == 11 ||
                      tracks[tr].iParticleID == -11 ||
                      tracks[tr].iParticleID == 22 )
                      bEMEnergyDepPSD2 = true;
                  if( tracks[tr].iParticleID == 2212 ) 
                      bNeutronHitPSD2 = true;
              } else { // end if volume = ls_target
                        

                  if( steps[st].dEnergyDep_keV > 0. ) {
                      if( steps[st].sVolumeName == "cherenkov_pmt_holder" ||
                          steps[st].sVolumeName == "cherenkov_pmt" ||
                          steps[st].sVolumeName == "teflon_retaining_ring" ||
                          steps[st].sVolumeName == "aluminum_retaining_ring" )
                          bHitPMTAssembly = true;
                      dTotEDepInactive_keV += steps[st].dEnergyDep_keV;
                      nEnergyDepositsTotal++;
          ...
          //if( is_recoiling_nucleus ) printf("Track energy: %f\n",track_energy);
          if( is_recoiling_nucleus && track_energy > 10. && is_active){
              if( tracks[tr].iParticleID != 1000010020 )
                  nNuclearRecoilsActive++;
              if( tracks[tr].iParticleID == 2212 ) 
                  nProtonRecoilsActive++;
              if( tracks[tr].iParticleID > 1000060000 && tracks[tr].iParticleID < 1000070000 ) 
                  nCarbonRecoilsActive++;
              if( tracks[tr].iParticleID > 1000140000 && tracks[tr].iParticleID < 1000150000 ) 
                  nSiliconRecoilsActive++;
              if( track_energy > 100. )
                  { nNuclearRecoilsAbove100keVActive++; }//printf("Num NR above 100 keV: %d\n",nNuclearRecoilsAbove100keVActive); }
          }
	  //if( dTotEDepActive_keV > 4440. ) printf("Event: %d\n",i);
      } // end tracks loop
      dEventSizeInActive_mm = FindMaxDistance( positionsInActiveVolume );
      if( i == 86996 ) printf("dActiveRecoilCosTheta = %f\n",dActiveRecoilCosTheta);
      data->Fill();
      //printf("XeEnergy: %f\t, PSDEnergy: %f\n",dTotEDepXe_keV,dTotEDepPSD_keV); 
  } // end events loop
  data->Write();
  outfile->Close();
  return 0;
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
double TMSSimsAnalysisEnvironment::FindMaxDistance( vector<vector<double>> positionsVector ){

  double max_distance = -1.;
  double this_distance = -1.;
  for(int i=0; i<int(positionsVector.size()); i++) {
     double xi = positionsVector[i][0];
     double yi = positionsVector[i][1];
     double zi = positionsVector[i][2];
     for(int j=i+1; j<int(positionsVector.size()); j++) {
         double xj = positionsVector[j][0];
         double yj = positionsVector[j][1];
         double zj = positionsVector[j][2];
         this_distance = sqrt( pow(xi - xj,2.) +
                               pow(yi - yj,2.) +
                               pow(zi - zj,2.));
...
//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
void TMSSimsAnalysisEnvironment::SetOutputDir( string outDir_temp ) {
   outputDir = outDir_temp;
}

//-------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------
int TMSSimsAnalysisEnvironment::ReduceSimulatedDataByFile() {
